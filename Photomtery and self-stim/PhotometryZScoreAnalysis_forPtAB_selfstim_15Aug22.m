...
BLOCKPATH = fullfile(DATAPATH,'FP_SelfStim_Example-201130-083802'); %Data file have to be in the MATLAB\TDTMatlabSDK\Examples\ directory
...
REF_EPOC = 'PtAB'; % event store name. This holds behavioral codes that are read through Ports A & B on the front of the RZ
VALUE = 6; % score event code we are interested in; 1 is cue onset and 6 is photo-stimulation (reward)
